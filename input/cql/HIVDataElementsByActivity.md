...
Data elements for this activity can be collected using the [NACHCF2](Questionnaire-NACHCF2.html)

|Id|Label|Description|Type|Profile Path|
|---|---|---|---|---|
|NACHC.F2.DE108|Maternal Care|Procedures identifying Maternal Care for Pregnancy|CodeableConcept|[Procedure.code](StructureDefinition-maternal-care.html)|
|NACHC.F2.DE1131|Pregnancy Conditions|Conditions identified for Pregnancy|CodeableConcept|[Condition.code](StructureDefinition-pregnancy-conditions.html)|
|NACHC.F2.DE1|Pregnancy Encounters|Encounters in the usage of Pregnancy|CodeableConcept|[Encounter.type](StructureDefinition-pregnancy-encounters.html)|
|NACHC.F2.DE904|Pregnancy Observations|Observations identified for Pregnancy|CodeableConcept|[Observation.value[x]](StructureDefinition-pregnancy-observations.html)|
|NACHC.F2.DE672|Pregnancy Procedures|Procedures identified for Pregnancy|CodeableConcept|[Procedure.code](StructureDefinition-pregnancy-procedures.html)|
|NACHC.F2.DE42|Pregnancy Supervision|Procedures in the usage of the Supervision of Pregnancy|CodeableConcept|[Procedure.code](StructureDefinition-pregnancy-supervision.html)|
|NACHC.F2.DE38|Third Trimester Encounters|Third Trimester Encounters in the usage of Pregnancy|CodeableConcept|[Encounter.type](StructureDefinition-third-trimester-encounters.html)|

#### NACHC.G1 Pep

Data elements for this activity can be collected using the [NACHCG1](Questionnaire-NACHCG1.html)

|Id|Label|Description|Type|Profile Path|
|---|---|---|---|---|
|NACHC.G1.DE143|PEP Dispensed Medications|List of Medications Provisioned and Supplied for Non-Occupational Post Exposure Prophylaxis|CodeableConcept|[MedicationDispense.medication[x]](StructureDefinition-pep-dispensed-medications.html)|
|NACHC.G1.DE5|PEP Medication Prescriptions|List of Medication Prescriptions for Non-Occupational Post Exposure Prophylaxis|CodeableConcept|[MedicationRequest.medication[x]](StructureDefinition-pep-medication-prescriptions.html)|
|NACHC.G1.DE1|Post Exposure Prophylaxis|Concepts and Procedures Identifying Post Exposure Prophylaxis|CodeableConcept|[Procedure.code](StructureDefinition-post-exposure-prophylaxis.html)|

#### NACHC.G2 Prep

Data elements for this activity can be collected using the [NACHCG2](Questionnaire-NACHCG2.html)

|Id|Label|Description|Type|Profile Path|
|---|---|---|---|---|
|NACHC.G2.DE26|Prep Dispensed Medications|List of Medications Provisioned and Supplied for Non-Occupational Pre Exposure Prophylaxis|CodeableConcept|[MedicationDispense.medication[x]](StructureDefinition-prep-dispensed-medications.html)|
|NACHC.G2.DE1|Prep Medication Prescriptions|List of Medication Prescriptions for Non-Occupational Pre Exposure Prophylaxis|CodeableConcept|[MedicationRequest.medication[x]](StructureDefinition-prep-medication-prescriptions.html)|

#### NACHC.H1 Risk Factors

Data elements for this activity can be collected using the [NACHCH1](Questionnaire-NACHCH1.html)

|Id|Label|Description|Type|Profile Path|
|---|---|---|---|---|
|NACHC.H1.DE3|Patient Currently Pregnant|Whether the patient is currently pregnant?|boolean|[Observation.value[x]](StructureDefinition-patient-currently-pregnant.html)|
|NACHC.H1.DE7|Patient Diagnosed with Chlamydia|Whether the patient has been diagnosed with Chlamydia?|boolean|[Observation.value[x]](StructureDefinition-patient-diagnosed-with-chlamydia.html)|
|NACHC.H1.DE6|Patient Diagnosed with Gonorrhea|Whether the patient has been diagnosed with Gonorrhea?|boolean|[Observation.value[x]](StructureDefinition-patient-diagnosed-with-gonorrhea.html)|
|NACHC.H1.DE4|Patient Diagnosed with HCV|Whether the patient has been diagnosed with HCV?|boolean|[Observation.value[x]](StructureDefinition-patient-diagnosed-with-hcv.html)|
|NACHC.H1.DE5|Patient Diagnosed with Syphilis|Whether the patient has been diagnosed with Syphilis?|boolean|[Observation.value[x]](StructureDefinition-patient-diagnosed-with-syphilis.html)|
|NACHC.H1.DE8|Patient has used Injection Drugs|Whether the patient has been using Injection Drugs?|boolean|[Observation.value[x]](StructureDefinition-patient-has-used-injection-drugs.html)|
|NACHC.H1.DE10|Previous experience with PREP|Whether the patient has previously been given PREP?|boolean|[Observation.value[x]](StructureDefinition-previous-experience-with-prep.html)|
|NACHC.H1.DE2|Previous HIV Diagnosis|Whether the patient has previously been diagnosed with HIV?|boolean|[Observation.value[x]](StructureDefinition-previous-hiv-diagnosis.html)|
|NACHC.H1.DE1|Previous HIV Screening|Whether the patient has previously been screened for HIV?|boolean|[Observation.value[x]](StructureDefinition-previous-hiv-screening.html)|
|NACHC.H1.DE9|Seeking STD Treatment|Whether the patient is currently seeking evaluation and treatment of an STD?|boolean|[Observation.value[x]](StructureDefinition-seeking-std-treatment.html)|
|NACHC.H1.DE22|Sexual Activity - Coercion|Have you ever been coerced or pressured to have sex?|boolean|[Observation.value[x]](StructureDefinition-sexual-activity-coercion.html)|
|NACHC.H1.DE20|Sexual Activity - Drug or Alcohol Use|Have you or any of your partners used alcohol or drugs when you had sex?|boolean|[Observation.value[x]](StructureDefinition-sexual-activity-drug-or-alcohol-use.html)|
